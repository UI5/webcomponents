	...
	return (
		...
		>
			<div class={{
				...
				"ui5-banner-columns-equal": this.columnsRatio === "Equal" && this._hasStartContent && this._hasEndContent,
				"ui5-banner-columns-first-wider": this.columnsRatio === "FirstWider" && this._hasStartContent && this._hasEndContent,
			}} part="content">
