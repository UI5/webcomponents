...
class Search extends SearchField {
	...
	items!: DefaultSlot<Array<SearchItem | SearchItemGroup>>;
	 ...
	 */
	@slot()
	illustration!: Slot<Array<IllustratedMessage>>;
	 ...
	 */
	@slot()
	messageArea!: Slot<Array<SearchMessageArea>>;
