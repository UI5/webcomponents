...
import type { OpenUI5PopupClass, OpenUI5PopupBasedControlClass, PopupInfo } from "./patchPopup.js";
			...
			OpenUI5Support.initPromise = new Promise<void>(resolve => {
				window.sap.ui.require(["sap/ui/core/Core"], async (Core: OpenUI5Core) => {
					const callback = () => {
						...
						window.sap.ui.require(deps, (Popup: OpenUI5PopupClass, Dialog: OpenUI5PopupBasedControlClass, Popover: OpenUI5PopupBasedControlClass, Patcher: OpenUI5Patcher) => {
