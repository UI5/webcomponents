  ...
  return (
    <li
      className={clsx(
        ...
        items.every(item => item.className?.includes("expComponentBadge")) ? "expComponentBadge" : "",
        items.every(item => item.className?.includes("newComponentBadge")) ? "newComponentBadge" : "",
        'menu__list-item',
        {
