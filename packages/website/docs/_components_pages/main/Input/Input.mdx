...
import InteractiveIcons from "../../../_samples/main/Input/InteractiveIcons/InteractiveIcons.md";
...
### Interactive Icons
The Input can display interactive icons that users can click. Use the `ui5-input-icon` component for interactive icons with hover, focus, and active states.
