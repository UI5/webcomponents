...
### Decorative Mode
The Avatar can be set to decorative mode, making it purely visual without semantic content. This is useful when the avatar is used for visual purposes only and shouldn't be announced by screen readers.
