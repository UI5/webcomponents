...
import ShowTwoCalendars from "../../_samples/main/DateRangePicker/ShowTwoCalendars/ShowTwoCalendars.md";
...
This sample demonstrates the component with the `show-two-calendars` property enabled, which displays two consecutive months, making it easier to select date ranges.
<ShowTwoCalendars />
