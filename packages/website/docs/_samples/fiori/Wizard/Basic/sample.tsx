      ...
      <!-- <div style={{ height: "700px" }}> -->
        <Wizard id="wiz">
            <WizardStep icon="product" title-text="Product type" selected={true}>
                ...
                <Button id="wiz-toStep2" design="Emphasized">Step 2</Button>
            </WizardStep>
            <WizardStep icon="hint" title-text="Product Information" disabled={true}>
                ...
                <Button id="wiz-toStep3" design="Emphasized" hidden={true}>Step 3</Button>
            </WizardStep>
            <WizardStep icon="action-settings" title-text="Options" disabled={true}>
                ...
                <Button id="wiz-finalize" hidden={true} design="Emphasized">Finalize</Button>
            </WizardStep>
        </Wizard>
        <!-- </div> -->
    </>
