  ...
  return (
    <>
      ...
      <HeroBanner
        ...
        layout="FullWidth"
      >
        <p style={{ margin: 0 }}>You have 3 pending approvals and 12 new notifications since your last visit. Review your tasks below or use the quick actions to get started.</p>
