      ...
      <ui5-table id="table" overflow-mode="Popin">
        <TableHeaderRow slot="headerRow">
          <TableHeaderCell id="produtCol" width="200px">
            ...
            <ui5-table-header-cell-action-ai slot="action" id="aiActionProduct" ref={aiActionProductRef}></ui5-table-header-cell-action-ai>
          </TableHeaderCell>
          ...
          <TableHeaderCell id="priceCol" min-width="100px" horizontal-align="End" popin-text="Price in Popin" sort-indicator="Descending">
            <Label>Price</Label>
            <ui5-table-header-cell-action-ai slot="action" id="aiActionPrice" ref={aiActionPriceRef}></ui5-table-header-cell-action-ai>
          </TableHeaderCell>
        </TableHeaderRow>
        <TableRow row-key={0}>
