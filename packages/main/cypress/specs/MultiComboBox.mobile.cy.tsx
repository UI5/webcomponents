import { INPUT_SUGGESTIONS_TITLE, SHOW_SELECTED_BUTTON } from "../../src/generated/i18n/i18n-defaults.js";
...
describe("Accessibility", () => {
	...
	it("Should test dialog title with accessibleName present and tokenizer n-more is pressed", () => {
		cy.mount(
			<MultiComboBox accessibleName="Custom Title">
                <MultiComboBoxItem text="Item 1" selected />
                <MultiComboBoxItem text="Item 2" selected />
                <MultiComboBoxItem text="Item 3" />
                <MultiComboBoxItem text="Item 4" selected />
	...
	it("Should test dialog title with accessibleName present and MultiComboBox is focused", () => {
		cy.mount(
			<MultiComboBox accessibleName="Custom Title">
                <MultiComboBoxItem text="Item 1" selected />
                <MultiComboBoxItem text="Item 2" selected />
	...
	it("Should test dialog title with accessibleNameRef is present and tokenizer n-more is pressed", () => {
		cy.mount(
			<>
			<Label id="test-label">Custom Title</Label>
			<MultiComboBox accessibleNameRef="test-label">
                <MultiComboBoxItem text="Item 1" selected />
                <MultiComboBoxItem text="Item 2" selected />
                <MultiComboBoxItem text="Item 3" />
                <MultiComboBoxItem text="Item 4" selected />
	...
	it("Should test dialog title with accessibleNameRef is present and MultiComboBox is focused", () => {
		cy.mount(
			<>
			<Label id="test-label">Custom Title</Label>
			<MultiComboBox accessibleNameRef="test-label">
