...
/**
 * Custom component that implements IToolbarItem with overflowCloseEvents
...
class CustomOverflowComponent extends HTMLElement {
	...
	// Implements IToolbarItem.overflowCloseEvents
...
/**
 * Custom component that implements IToolbarItem with additional custom events
...
describe("Toolbar Item Closing Events - overflowCloseEvents functionality (IToolbarItem)", () => {
