...
export function isToolbarArrowNavProvider(el: unknown): el is IToolbarArrowNavProvider {
	return typeof (el as IToolbarArrowNavProvider).getArrowNavState === "function";
}
