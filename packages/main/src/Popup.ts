...
abstract class Popup extends UI5Element {
	...
	*/
	 ...
	 *
	 * A screen reader scopes its accessibility tree to a popup that lives in the top layer so a body-level
	 * aria-live region is silenced while the popup is open.
	 * @protected
	 */
